...
namespace MAA.Infrastructure.Migrations
{
    ...
    [Migration("20260211130000_AddEligibilityRules")]
    partial class AddEligibilityRules
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAA.Domain.Eligibility.FederalPovertyLevel", b =>
                {
                    ...
                    b.ToTable("federal_poverty_levels_v2", (string)null);
                });

            modelBuilder.Entity("MAA.Domain.Eligibility.ProgramDefinition", b =>
                {
                    b.Property<string>("ProgramCode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.ToTable("program_definitions", (string)null);
                });

            modelBuilder.Entity("MAA.Domain.Eligibility.RuleSetVersion", b =>
                {
                    ...
                    b.ToTable("eligibility_rule_set_versions", (string)null);
                });

            modelBuilder.Entity("MAA.Domain.Eligibility.EligibilityRule", b =>
                {
                    ...
                    b.ToTable("eligibility_rules_v2", (string)null);
                });
            ...
            modelBuilder.Entity("MAA.Domain.Eligibility.EligibilityRule", b =>
                {
                    b.HasOne("MAA.Domain.Eligibility.ProgramDefinition", "Program")
                        .WithMany("Rules")
                    ...
                    b.HasOne("MAA.Domain.Eligibility.RuleSetVersion", "RuleSetVersion")
                        .WithMany("Rules")
