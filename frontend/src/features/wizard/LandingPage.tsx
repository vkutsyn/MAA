  ...
  return (
    <main className="mx-auto max-w-2xl space-y-8 px-4 py-8">
              ...
              >
                {isStarting ? (
                  <>
                    ...
                    <span className="sr-only">Starting your eligibility check</span>
                  </>
                ) : (
      ...
      <Card className="bg-muted/50">
        ...
        <CardContent>
          <ul className="space-y-2 text-sm text-muted-foreground" aria-label="Wizard process information">
      ...
      <section className="text-center">
        <p className="text-xs text-muted-foreground">
          <span className="font-semibold">Disclaimer:</span> This tool provides an estimate only. Final eligibility is determined by your state's
