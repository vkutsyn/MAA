...
export function ValidationMessage({ 
  ...
  const typeStyles = {
    ...
    warning: 'text-amber-700 bg-amber-50 border-amber-300 dark:text-amber-400 dark:bg-amber-950 dark:border-amber-800',
    success: 'text-green-700 bg-green-50 border-green-300 dark:text-green-400 dark:bg-green-950 dark:border-green-800',
      ...
      {showValidation && (
        <>
          ...
          {isValid && successMessage && (
            <ValidationMessage type="success">{successMessage}</ValidationMessage>
          )}
        </>
      )}
    </div>
