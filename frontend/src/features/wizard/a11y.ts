...
export function announceToScreenReader(
  ...
  let region = document.querySelector(`[role="status"][aria-live="${priority}"]`) as HTMLElement | null
  if (!region) {
 ...
 */
export function moveFocus(container: HTMLElement | string, reverse = false): boolean {
